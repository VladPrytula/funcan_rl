...
|----|------|-------------------|----------|---------|------------|-------|
| DEF-1.1.1 | $\sigma$-algebra | Collection $\mathcal{A}$ closed under complements, countable unions | Week_1/final/day_1/Day_1_FINAL.md:91 | DEF-1.1.2, DEF-1.2.1, THM-1.1.1, THM-1.3.1, THM-1.3.3, DEF-2.2.A2, THM-2.2.A1 | @folland:real_analysis:1999 §1.1 | [Standard] |
...
| DEF-2.2.A1 | $\Pi$-System | Collection $\mathcal{P}$ closed under finite intersections | Week_2/final/day_2/Appendix_A2.1_Generator_Based_Sigma_Algebras.md:41 | DEF-2.2.A2, THM-2.2.A1, THM-2.2.A3, THM-1.3.3 | @folland:real_analysis:1999 §1.2 | [Standard] Foundation for $\Pi$-$\lambda$ theorem |
...
| DEF-2.2.A3 | Monotone Class | Collection closed under monotone limits (increasing/decreasing sequences) | Week_2/final/day_2/Appendix_A2.1_Generator_Based_Sigma_Algebras.md:185 | THM-2.2.A2, THM-1.3.3 | @folland:real_analysis:1999 §1.3 | [Standard] Used for functional limit arguments |
...
| THM-1.3.1 | Fatou's Lemma | If fₙ ≥ 0 non-negative measurable, then ∫(lim inf fₙ) dμ ≤ lim inf(∫fₙ dμ) | Week_1/drafts/day_3/Day_3.md:79 | Proved | THM-1.2.1 | @folland:real_analysis:1999 Thm 2.18 | [Standard] Full proof via MCT applied to gₙ = inf_{k≥n} fₖ. Foundation for DCT |
| THM-1.3.2 | Dominated Convergence Theorem (DCT) | If fₙ → f pointwise a.e., \|fₙ\| ≤ g integrable, then lim ∫fₙ dμ = ∫f dμ | Week_1/drafts/day_3/Day_3.md:151 | Proved | THM-1.3.1, THM-1.2.1 | @folland:real_analysis:1999 Thm 2.24, @durrett:probability:2019 §1.6 | [Standard] Full proof via Fatou applied to g±fₙ. Crown jewel of integration theory. Essential for RL convergence |
| THM-1.3.3 | Monotone Class Theorem for Functions | If H contains indicators of algebra A, closed under linear combinations and monotone limits, then H contains all bounded σ(A)-measurable functions | Week_1/drafts/day_3/Day_3_exercises.md:187 | Proved | DEF-1.1.1, DEF-2.2.A1, DEF-2.2.A3, THM-2.2.A1 | @folland:real_analysis:1999 (various sections) | [Standard] Full proof via Dynkin π-λ. Exercise 3, formal proof. Essential for conditional expectation (Week 6) and Bellman operators (Week 25) |
...
| EX-1.3.1 | Escaping Mass (DCT Failure Without Domination) | fₙ(x) = (1/n)𝟙_{[0,n]}(x) on ℝ: fₙ → 0 pointwise but ∫fₙ = 1 for all n, no integrable dominating function | Week_1/drafts/day_3/Day_3.md:238 | Counterexample | @folland:real_analysis:1999 (construction) | [Original] Shows domination hypothesis is necessary in DCT. Mass escapes to infinity as support grows unboundedly |
| EX-1.3.2 | Typewriter Sequence (DCT Failure Without Pointwise Convergence) | fₙ = 𝟙_{Iₙ} on [0,1] where {Iₙ} enumerates dyadic intervals: dominated by g≡1 but no pointwise limit exists | Week_1/drafts/day_3/Day_3.md:262 | Counterexample | [Standard construction] | [Original] Shows pointwise convergence is necessary in DCT. Sequence oscillates forever despite domination |
| EX-1.3.3 | L¹ Convergence Implies A.E. Convergent Subsequence | If fₙ → f in L¹, extract subsequence f_{nₖ} with ∫\|f_{nₖ}-f\| < 1/2^k, apply Markov + Borel-Cantelli | Week_1/drafts/day_3/Day_3_exercises.md:7 | Exercise (Instructive) | @durrett:probability:2019 §1.6, §2.3 | [Original] Exercise 1 with full proof. Fundamental for stochastic approximation (Week 34+). Uses Markov's inequality and Borel-Cantelli lemma |
| EX-1.3.4 | MCT/DCT Hypothesis Necessity (3 Counterexamples) | (a) MCT fails without monotonicity: fₙ oscillates 0,2,0,2,... (b) DCT fails without pointwise convergence: Typewriter (c) DCT fails without domination: Escaping Mass | Week_1/drafts/day_3/Day_3_exercises.md:81 | Counterexample (Synthesis) | Construction details in exercises | [Original] Exercise 2 with 3 sub-examples. Demonstrates sharpness of MCT and DCT hypotheses. Informs RL proof strategy (boundedness + convergence) |
